...
SERVERS = [
  {
    ...
    :cpu          => 4,
    :gui          => true,
    :playbook     => 'playbook-eventhorizon.yml',  # Gets appended to playbook-<var_name>.yml
    :ports        => []
  } ,{
    :hostname     => 'quantum',
    :ip           => NETWORK + '3',
    ...
    :cpu          => 2,
    :gui          => true,
    :playbook     => 'playbook-quantum.yml',  # Gets appended to playbook-<var_name>.yml
    :ports        => []
  } ,{
    :hostname     => 'proxy',
    :ip           => NETWORK + '4',
    ...
    :cpu          => 2,
    :gui          => false,
    :playbook     => 'playbook-proxy.yml',  # Gets appended to playbook-<var_name>.yml
    :ports        => []
  } ,{
    :hostname     => 'stack',
    :ip           => NETWORK + '5',
  ...
  SERVERS.each do |machine|
    ...
    #   SHELL
      ...
      node.vm.provision "ansible" do |ansible|
        ...
        ansible.galaxy_role_file = "ansible/requirements-#{machine[:hostname]}.yml"
        ...
        ansible.playbook  = "ansible/playbook-#{machine[:hostname]}.yml"
